				...
				<div
					...
					<div class="col-12">
						<div class="bg-secondary rounded h-100 p-4">
							<h2 class="mb-4 text-center">Contacts List</h2>
										...
										<c:forEach var="contact" items="${contacts}">
											<tr>
												...
												<td class="text-center"><a
													href="${base}/admin/contacts/contact_details/${contact.id}" type="button"
													class="btn btn-outline-info"> Bấm để xem nội dung </a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
